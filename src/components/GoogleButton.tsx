...
export default function GoogleButton({ label = "Continuar con Google" }: { label?: string }) {
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 py-3 border border-outline-variant text-on-surface hover:border-primary transition rounded"
    >
      <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path fill="#4CAF50" d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29.1 35 26.7 36 24 36c-5.3 0-9.7-2.6-11.3-6.9l-6.5 5C9.6 39.6 16.2 44 24 44z" />
        <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.1 5.6l6.2 5.2C41.4 36 44 30.6 44 24c0-1.3-.1-2.3-.4-3.5z" />
      </svg>
