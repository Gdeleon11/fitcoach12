// Ported from Stitch mockup (nav chrome stripped): fitcoach_12_reporte_mensual_de_composici_n_corporal
...
<div class="inline-block px-3 py-1 bg-primary-container/10 border border-primary-container/30 font-label-caps text-[10px] text-primary">PROXIMA FASE: MES 4</div>
<h2 class="font-display-lg text-headline-md md:text-display-lg text-on-surface">Estrategia de Transición: <span class="text-primary-container">Fase de Pulido Metabólico</span></h2>
<p class="font-body-regular text-body-regular text-on-surface-variant max-w-2xl leading-relaxed">
                                Tras consolidar ganancias de masa magra significativas en el Mes 3, el algoritmo recomienda una fase de <strong class="text-on-surface">"Mini-Cut" de 21 días</strong>. El objetivo es sensibilizar la respuesta a la insulina y eliminar la retención hídrica residual antes de iniciar el siguiente macrociclo de fuerza.
                            </p>
...
<span class="font-label-caps text-[11px] text-on-surface">HIIT Suplemental</span>
</div>
</div>
</div>
