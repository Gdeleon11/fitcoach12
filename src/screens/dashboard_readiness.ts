// Ported from Stitch mockup (nav chrome stripped): fitcoach_12_dashboard_con_readiness_score_integrado
...
<!-- Meal Timing / Window -->
<div class="col-span-12 md:col-span-4 lg:col-span-5 glass-card p-6 flex flex-col justify-between">
<div>
<div class="flex items-center justify-between mb-6">
<span class="font-label-caps text-label-caps text-on-surface-variant">PRÓXIMA COMIDA</span>
<span class="font-label-caps text-label-caps text-tertiary-fixed-dim">COMIDA 2 DE 4</span>
</div>
<div class="flex items-center gap-4 mb-8">
<span class="material-symbols-outlined text-display-lg text-primary">schedule</span>
<div>
<h3 class="font-headline-md text-headline-md">13:30</h3>
<p class="font-label-caps text-label-caps text-on-surface-variant">VENTANA: 7AM - 5PM</p>
</div>
</div>
</div>
<div class="space-y-4">
<div class="flex justify-between text-label-caps font-label-caps text-on-surface-variant">
<span class="">PROGRESO AYUNO</span>
<span class="">82%</span>
</div>
<div class="w-full bg-surface-container-highest h-2">
<div class="bg-primary-container h-2 w-[82%]"></div>
</div>
</div>
</div>
